...
<head>
    <meta charset="utf-8" />
    <title>DO | Pagina de ingreso</title>
    ...
    <div class="login login-v1">
        ...
        <div class="login-container">
            ...
            <div class="login-header">
                <div class="brand">
                     <span class="logo" style="background:#93b738" ></span> <b>DO</b> INTRANET
                     <small> Distribuidora Ortiz</small>
                </div>
                <div class="align-content-center">
                    <a href="/" title="Click para regresar al incio">
                        <img  height="80px" width="80px" src="../assets/img/DO/LogoDO.png">
                    </a>
                </div>
            </div>
            <!-- end login-header -->
