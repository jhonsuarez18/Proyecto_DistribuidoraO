...
<div id="response">
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <div class="col-xl-12  ">
                <button id="addmarca" class="btn btn-success " title="click para agregar marca"
                        data-toggle="modal" data-target="#modal_dialog_add_marca">
        ...
        <div class="col-xl-12 ">
            <div class="modal fade" id="modal-dialog_add_marca">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                                ...
                                <div class="col-xl-12 ">
                                    <div class="form-group-lg">
                                        ...
                                        <input id="marca" type="text" class="form-control form-control-sm" autocomplete="off"
                            ...
                            <div class="col-xl-12 text-center">
                                ...
                                <button id="enviar" class="btn btn-success " title="click para agregar marca
        ...
        <div class="col-xl-12 ">
            <div class="modal fade" id="modal-dialog-edit_marca">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <input id="idmarca" hidden>
                            <div class="row ">
                                <div class="col-xl-12 ">
                                    <label for="edmarca">MARCA
                                        <req>*</req>
                                    </label>
                                    <input id="edmarca" type="text" class="form-control form-control-sm" autocomplete="off"
                                ...
                                <div class="col-xl-12 text-center">
                                    ...
                                    <a href="javascript:;" class="btn btn-danger" data-dismiss="modal"><i
                                            class="fas fa-lg fa-fw m-r-10 fa-times"></i>Cancelar</a>
                                    <button id="enviared" class="btn btn-success " title="click para editar marca
...
<script>
    $.getScript('../assets/plugins/sweetalert/dist/sweetalert.min.js').done(function () {
        $.when(
            ...
            $.getScript('../js/intranet/mantenimiento/agregarmarca.js'),
